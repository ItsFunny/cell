...
public class CellDiscoveryException extends AbstractRuntimeException
{
     ...
     */
    public CellDiscoveryException(String message)
    {
        super(message);
    }
     ...
     * @since 1.4
     */
    public CellDiscoveryException(String message, Throwable cause)
    {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public CellDiscoveryException(Throwable cause)
    {
        super(cause);
    }
     ...
     * @since 1.4
     */
    public CellDiscoveryException(String message, Throwable cause, Long code, String logicMsg)
    {
