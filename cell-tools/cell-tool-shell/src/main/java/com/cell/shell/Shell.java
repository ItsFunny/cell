...
import com.cell.shell.impl.LinuxShellBuilder;
import com.cell.shell.impl.UnixShellBuilder;
import com.cell.shell.impl.WindowsShellBuilder;
...
public class Shell
{
    ...
    static
    {
        ...
        } else if ("linux".equalsIgnoreCase(os.toLowerCase()))
        {
        ...
        {
            DEFAULT_ENCODE = "utf-8";
            shellBuilder = new UnixShellBuilder();
        }
    }
