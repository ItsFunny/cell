package com.cell.rpc.grpc.client.postprocessor;

import com.cell.grpc.common.annotation.GRPCClient;
import com.cell.node.spring.adapter.IBeanPostProcessortAdapter;
import com.cell.rpc.grpc.client.autoconfigure.annotation.GrpcClientBean;
import com.cell.rpc.grpc.client.channelfactory.GRPCChannelFactory;
import com.cell.rpc.grpc.client.inject.StubTransformer;
import com.cell.rpc.grpc.client.stub.IStubFactory;
